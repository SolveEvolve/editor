...
namespace GaussianSplatting.Runtime
{
    public class GaussianSplatAsset : ScriptableObject
    {
        ...
        // â”€â”€ Runtime data (for loading files at runtime without TextAssets) â”€â”€
        ...
        [NonSerialized] public ChunkInfo[] runtimeChunkData;
        ...
        public bool HasChunkData => m_ChunkData != null || runtimeChunkData != null;
        ...
        public long GetChunkDataSize() => m_ChunkData != null ? m_ChunkData.dataSize : (runtimeChunkData?.LongLength ?? 0) * UnsafeUtility.SizeOf<ChunkInfo>();
        ...
        public NativeArray<ChunkInfo> GetChunkData()
            => m_ChunkData != null ? m_ChunkData.GetData<ChunkInfo>() : new NativeArray<ChunkInfo>(runtimeChunkData, Allocator.Temp);
